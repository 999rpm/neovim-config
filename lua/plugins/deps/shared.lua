...
--
-- nvim-lua/plenary.nvim: async/job-control/path/test utilities. Consumers: plugins/explorer/
-- neo-tree.lua, plugins/editor/harpoon.lua, plugins/editor/todo-comments.lua, plugins/search/
